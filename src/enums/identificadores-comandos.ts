...
export enum IdentificadoresComandos {
  ...
  CMD_OBTER_CONFIGURAR_ANGLE_DIST_OVERSPD= 'CMD_OBTER_CONFIGURAR_ANGLE_DIST_OVERSPD', // Obter o ângulo para envio de dados, envio de dados pela distância percorrida e velocidade máxima permitida.
}
